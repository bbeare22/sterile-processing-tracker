...
router.post('/plans', requireAuth, requireRole('supervisor'), async (req, res) => {
  try {
...
router.patch('/plans/:id/toggle', requireAuth, requireRole('supervisor'), async (req, res) => {
  try {
    const { id } = req.params;
...
router.post('/tasks/generate', requireAuth, requireRole('supervisor'), async (req, res) => {
  try {
...
router.get('/tasks', requireAuth, async (req, res) => {
  try {
    ...
    if (machineId && mongoose.isValidObjectId(machineId)) filter.machineId = machineId;
